...
| Line-number basis | **1-based and inclusive** |
...
| **RP** | Rescue Pack v2 validation, replay ledger and restricted assist | **12,023–12,075** | High |
...
| Rescue Pack contents | Rescue Pack v2 path, **12,023–12,075** | Replay, forgery or unsafe interpretation could mislead a recipient. |
...
| Complete contract table | 1,104–1,181 | `const VG473_CONTRACTS` |
...
**Legacy decrypt sub-block:** **11,361–11,431**  
...
| Legacy decrypt execution | 11,417–11,428 | `decryptLegacyBackup` |
...
**Rescue Pack validation and assist:** **12,023–12,075**  
...
| Static application shell | **352–846** | Mostly fixed markup; action-bearing attributes are validated by WP7. |
